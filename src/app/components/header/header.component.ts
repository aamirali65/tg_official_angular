  ...
  ngOnInit() {
    ...
    if (canvasCartTrigger) {
      canvasCartTrigger.addEventListener('click', () => {
        document.querySelector('.or-ofcanvas-cart-wrapper')?.classList.toggle('or-canvas-cart-on');
      });
    }
    ...
    const dropdownBtns = document.querySelectorAll('.mobile_menu li.dropdown .dropdown-btn');
    if (dropdownBtns) {
...
if ($mobileMenuWrap.hasClass('mobile_menu_on')) {
  ...
  //   const openMobileMenu:any = document.querySelector('.mobile_menu_close');
  //     openMobileMenu.addEventListener('click', () => {
  //       document.querySelector('.mobile_menu_wrap')?.classList.toggle('mobile_menu_on');
  //       document.body.classList.toggle('mobile_menu_overlay_on');
  //     });
